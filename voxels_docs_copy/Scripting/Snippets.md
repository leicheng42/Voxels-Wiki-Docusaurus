...
```js
/* for more info go to 
https://voxels-wiki.leicheng42.com/Scripting/Examples/Click-trigger
*/
...
```js
/* for more info go to 
https://voxels-wiki.leicheng42.com/Scripting/Examples/welcome_message
*/
...
/* for more info go to 
https://voxels-wiki.leicheng42.com/Scripting/Examples/loop-images-timer
*/
...
```js
/* for more info go to 
https://voxels-wiki.leicheng42.com/Scripting/Examples/Youtube_theater
*/
...
```js
/* for more info go to 
https://voxels-wiki.leicheng42.com/Scripting/Examples/trap_door
*/
...
// https://voxels-wiki.leicheng42.com/vox_library/pressure-plate.vox
